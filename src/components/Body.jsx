    ...
    return (
        <section className='px-6 py-1 '>
            <div className='flex justify-between items-center ' >
                <div>
                    <h1 className='font-Bree text-2xl ' >{search?.word ?? <p className='animate-bounce text-red-700 text-xl' >Write a word!</p>}</h1>
            ...
            <footer className='bg-yellow-100 flex flex-col items-center '>
